...
SUB_SUPPORT_URL = config("SUB_SUPPORT_URL", default="https://t.me/YoVPNRobot")
SUB_PROFILE_TITLE = config("SUB_PROFILE_TITLE", default="YoVPN")
SUB_BOT_NAME = config("SUB_BOT_NAME", default="YoVPN")
